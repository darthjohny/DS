...
- [quality_gate_calibration.ipynb](/Users/evgeniikuznetsov/Desktop/dspro-vkr/analysis/notebooks/research/quality_gate_calibration.ipynb)
  - разбор `quality_gate`, состояний `quality/ood`, причин и review-bucket;
  - сравнение baseline, relaxed и strict policy.
- [coarse_ob_domain_shift.ipynb](/Users/evgeniikuznetsov/Desktop/dspro-vkr/analysis/notebooks/research/coarse_ob_domain_shift.ipynb)
  ...
  - сравнение train-time и downstream доменов, физических признаков и вероятностей.
...
- активный notebook отвечает за обзор, визуализацию и выводы, а не за тяжелую бизнес-логику;
