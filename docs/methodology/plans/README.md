...
Здесь собраны документы, которые описывают:

- что проект делает дальше;
- зачем нужен следующий этап;
- почему выбран конкретный путь реализации;
- какие ограничения и гипотезы учитываются.
...
принятые решения. Внутренние рабочие черновики и детальные пошаговые заметки в
публичный слой не входят.
