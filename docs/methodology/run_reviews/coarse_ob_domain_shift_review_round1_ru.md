...
То есть сейчас преждевременный узкий повторный запуск обучения выглядит плохо обоснованным.
...
- только после этого решать, нужен ли:
  ...
  - relabeling,
  - или уже потом узкий повторный запуск обучения и перенастройка весов классов.
